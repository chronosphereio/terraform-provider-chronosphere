...
func resourceVictoropsExternalConnection() *schema.Resource {
	...
	return &schema.Resource{
		...
		Description:   "Workspace-scoped VictorOps (Splunk On-Call) credentials that downstream notifiers can reference. Centralizes the REST integration API key so it isn't duplicated across notifiers; modern equivalent of the per-notifier credentials.",
