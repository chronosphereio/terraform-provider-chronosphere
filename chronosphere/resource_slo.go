...
func (sloConverter) toModel(s *intschema.Slo) (*models.ConfigunstableSLO, error) {
	...
	if s.Sli.EndpointAvailability != nil {
		endpointAvailability = &models.SLIEndpointAvailabilityConfig{
			SuccessCodes:            s.Sli.EndpointAvailability.SuccessCodes,
	...
	collRef := &models.Configv1CollectionReference{
		Type: models.Configv1CollectionReferenceType(v1CollRef.Type),
		Slug: v1CollRef.Slug,
	}
...
func (sloConverter) fromModel(
	...
	return &intschema.Slo{
		Name: s.Name,
		Slug: s.Slug,
		CollectionId: tfid.Slug(collectionIDFromRef(s.CollectionRef.Slug, &v1models.Configv1CollectionReference{
			Type: v1models.Configv1CollectionReferenceType(s.CollectionRef.Type),
			Slug: s.CollectionRef.Slug,
		})),
