...
import (
	...
	"github.com/chronosphereio/terraform-provider-chronosphere/chronosphere/pkg/configv1/client/command_center_group"
...
func ListCloudIntegrations(
	...
	return ListCloudIntegrationsByFilter(ctx, client, Filter{})
}

func ListCloudIntegrationsBySlugs(
	ctx context.Context,
	client *configv1.Client,
	slugs []string,
) ([]*configv1models.Configv1CloudIntegration, error) {
...
func ListCloudIntegrationsByNames(
	ctx context.Context,
	client *configv1.Client,
	names []string,
) ([]*configv1models.Configv1CloudIntegration, error) {
...
func ListCloudIntegrationsByFilter(
	ctx context.Context,
	client *configv1.Client,
	f Filter,
	opts ...func(*cloud_integration.ListCloudIntegrationsParams),
) ([]*configv1models.Configv1CloudIntegration, error) {
	var (
		nextToken string
		result    []*configv1models.Configv1CloudIntegration
	)
	for {
		p := &cloud_integration.ListCloudIntegrationsParams{
			Context:   ctx,
			PageToken: &nextToken,
			Slugs:     f.Slugs,
			Names:     f.Names,
		...
		resp, err := client.CloudIntegration.ListCloudIntegrations(p)
		if err != nil {
			return nil, err
		}
		...
		nextToken = ""
		if resp.Payload != nil {
			for _, v := range resp.Payload.CloudIntegrations {
				result = append(result, v)
			}
			if resp.Payload.Page != nil {
				nextToken = resp.Payload.Page.NextToken
...
func ListCommandCenterGroups(
	ctx context.Context,
	client *configv1.Client,
) ([]*configv1models.Configv1CommandCenterGroup, error) {
	return ListCommandCenterGroupsByFilter(ctx, client, Filter{})
}

func ListCommandCenterGroupsBySlugs(
	ctx context.Context,
	client *configv1.Client,
	slugs []string,
) ([]*configv1models.Configv1CommandCenterGroup, error) {
...
func ListCommandCenterGroupsByNames(
	ctx context.Context,
	client *configv1.Client,
	names []string,
) ([]*configv1models.Configv1CommandCenterGroup, error) {
...
func ListCommandCenterGroupsByFilter(
	ctx context.Context,
	client *configv1.Client,
	f Filter,
	...
	var (
		nextToken string
		result    []*configv1models.Configv1CommandCenterGroup
	)
	for {
...
func ListSLOs(
	...
	return ListSLOsByFilter(ctx, client, Filter{})
}

func ListSLOsBySlugs(
	ctx context.Context,
	client *configv1.Client,
	slugs []string,
) ([]*configv1models.Configv1SLO, error) {
...
func ListSLOsByFilter(
	...
	var (
		nextToken string
		result    []*configv1models.Configv1SLO
	)
	for {
...
func ListSyntheticTests(
	...
	return ListSyntheticTestsByFilter(ctx, client, Filter{})
}

func ListSyntheticTestsBySlugs(
	ctx context.Context,
	client *configv1.Client,
	slugs []string,
) ([]*configv1models.Configv1SyntheticTest, error) {
...
func ListSyntheticTestsByNames(
	ctx context.Context,
	client *configv1.Client,
	names []string,
) ([]*configv1models.Configv1SyntheticTest, error) {
...
func ListSyntheticTestsByFilter(
	ctx context.Context,
	client *configv1.Client,
	f Filter,
