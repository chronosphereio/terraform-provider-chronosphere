...
func resourcePagerdutyExternalConnection() *schema.Resource {
	...
	return &schema.Resource{
		...
		Description:   "Workspace-scoped PagerDuty credentials that downstream notifiers can reference. Holds either a PagerDuty Events integration key (for alert delivery) or a REST API token (for incident note polling); modern equivalent of the per-notifier credentials.",
