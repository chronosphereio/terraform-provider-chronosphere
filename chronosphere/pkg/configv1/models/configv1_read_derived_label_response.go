...
func (m *Configv1ReadDerivedLabelResponse) validateDerivedLabel(formats strfmt.Registry) error {
...
func (m *Configv1ReadDerivedLabelResponse) contextValidateDerivedLabel(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1ReadDerivedLabelResponse) UnmarshalBinary(b []byte) error {
	var res Configv1ReadDerivedLabelResponse
