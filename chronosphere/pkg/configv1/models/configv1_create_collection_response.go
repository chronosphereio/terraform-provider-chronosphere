...
func (m *Configv1CreateCollectionResponse) validateCollection(formats strfmt.Registry) error {
...
func (m *Configv1CreateCollectionResponse) contextValidateCollection(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1CreateCollectionResponse) UnmarshalBinary(b []byte) error {
	var res Configv1CreateCollectionResponse
