...
func (m *Configv1UpdateNotifierResponse) validateNotifier(formats strfmt.Registry) error {
...
func (m *Configv1UpdateNotifierResponse) contextValidateNotifier(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1UpdateNotifierResponse) UnmarshalBinary(b []byte) error {
	var res Configv1UpdateNotifierResponse
