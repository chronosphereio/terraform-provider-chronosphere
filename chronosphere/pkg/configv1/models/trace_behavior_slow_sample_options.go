...
func (m *TraceBehaviorSlowSampleOptions) validateSamplingType(formats strfmt.Registry) error {
...
func (m *TraceBehaviorSlowSampleOptions) contextValidateSamplingType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TraceBehaviorSlowSampleOptions) UnmarshalBinary(b []byte) error {
	var res TraceBehaviorSlowSampleOptions
