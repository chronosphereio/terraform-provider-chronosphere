...
func (m *Configv1ReadMutingRuleResponse) validateMutingRule(formats strfmt.Registry) error {
...
func (m *Configv1ReadMutingRuleResponse) contextValidateMutingRule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1ReadMutingRuleResponse) UnmarshalBinary(b []byte) error {
	var res Configv1ReadMutingRuleResponse
