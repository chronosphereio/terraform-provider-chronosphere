...
func (m *Configv1ExternalConnectionOpsGenieConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Configv1ExternalConnectionOpsGenieConfig) validateHTTPConfig(formats strfmt.Registry) error {
...
func (m *Configv1ExternalConnectionOpsGenieConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Configv1ExternalConnectionOpsGenieConfig) contextValidateHTTPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1ExternalConnectionOpsGenieConfig) UnmarshalBinary(b []byte) error {
	var res Configv1ExternalConnectionOpsGenieConfig
