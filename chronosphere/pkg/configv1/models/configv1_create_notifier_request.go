...
func (m *Configv1CreateNotifierRequest) validateNotifier(formats strfmt.Registry) error {
...
func (m *Configv1CreateNotifierRequest) contextValidateNotifier(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1CreateNotifierRequest) UnmarshalBinary(b []byte) error {
	var res Configv1CreateNotifierRequest
