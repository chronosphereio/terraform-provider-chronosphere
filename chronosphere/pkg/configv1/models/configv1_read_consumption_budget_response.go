...
func (m *Configv1ReadConsumptionBudgetResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Configv1ReadConsumptionBudgetResponse) validateConsumptionBudget(formats strfmt.Registry) error {
...
func (m *Configv1ReadConsumptionBudgetResponse) contextValidateConsumptionBudget(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1ReadConsumptionBudgetResponse) UnmarshalBinary(b []byte) error {
	var res Configv1ReadConsumptionBudgetResponse
