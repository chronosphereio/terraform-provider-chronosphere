...
func (m *Configv1UpdateDashboardResponse) validateDashboard(formats strfmt.Registry) error {
...
func (m *Configv1UpdateDashboardResponse) contextValidateDashboard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1UpdateDashboardResponse) UnmarshalBinary(b []byte) error {
	var res Configv1UpdateDashboardResponse
