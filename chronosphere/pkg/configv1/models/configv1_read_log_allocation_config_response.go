...
func (m *Configv1ReadLogAllocationConfigResponse) validateLogAllocationConfig(formats strfmt.Registry) error {
...
func (m *Configv1ReadLogAllocationConfigResponse) contextValidateLogAllocationConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1ReadLogAllocationConfigResponse) UnmarshalBinary(b []byte) error {
	var res Configv1ReadLogAllocationConfigResponse
