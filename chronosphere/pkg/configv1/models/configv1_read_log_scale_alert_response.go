...
func (m *Configv1ReadLogScaleAlertResponse) validateLogScaleAlert(formats strfmt.Registry) error {
...
func (m *Configv1ReadLogScaleAlertResponse) contextValidateLogScaleAlert(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1ReadLogScaleAlertResponse) UnmarshalBinary(b []byte) error {
	var res Configv1ReadLogScaleAlertResponse
