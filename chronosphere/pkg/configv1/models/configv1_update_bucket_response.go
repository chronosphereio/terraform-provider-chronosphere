...
func (m *Configv1UpdateBucketResponse) validateBucket(formats strfmt.Registry) error {
...
func (m *Configv1UpdateBucketResponse) contextValidateBucket(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1UpdateBucketResponse) UnmarshalBinary(b []byte) error {
	var res Configv1UpdateBucketResponse
