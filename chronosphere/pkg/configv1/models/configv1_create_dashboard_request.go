...
func (m *Configv1CreateDashboardRequest) validateDashboard(formats strfmt.Registry) error {
...
func (m *Configv1CreateDashboardRequest) contextValidateDashboard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1CreateDashboardRequest) UnmarshalBinary(b []byte) error {
	var res Configv1CreateDashboardRequest
