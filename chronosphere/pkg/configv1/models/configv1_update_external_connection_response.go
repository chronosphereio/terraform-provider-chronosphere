...
func (m *Configv1UpdateExternalConnectionResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Configv1UpdateExternalConnectionResponse) validateExternalConnection(formats strfmt.Registry) error {
...
func (m *Configv1UpdateExternalConnectionResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Configv1UpdateExternalConnectionResponse) contextValidateExternalConnection(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1UpdateExternalConnectionResponse) UnmarshalBinary(b []byte) error {
	var res Configv1UpdateExternalConnectionResponse
