...
func (m *Configv1CreateConsumptionBudgetResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Configv1CreateConsumptionBudgetResponse) validateConsumptionBudget(formats strfmt.Registry) error {
...
func (m *Configv1CreateConsumptionBudgetResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Configv1CreateConsumptionBudgetResponse) contextValidateConsumptionBudget(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1CreateConsumptionBudgetResponse) UnmarshalBinary(b []byte) error {
	var res Configv1CreateConsumptionBudgetResponse
