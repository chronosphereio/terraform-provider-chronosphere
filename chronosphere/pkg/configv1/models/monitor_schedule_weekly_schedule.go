...
// MonitorScheduleWeeklySchedule monitor schedule weekly schedule
//
// swagger:model MonitorScheduleWeeklySchedule
type MonitorScheduleWeeklySchedule struct {
...
// Validate validates this monitor schedule weekly schedule
func (m *MonitorScheduleWeeklySchedule) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MonitorScheduleWeeklySchedule) validateFriday(formats strfmt.Registry) error {
...
func (m *MonitorScheduleWeeklySchedule) validateMonday(formats strfmt.Registry) error {
...
func (m *MonitorScheduleWeeklySchedule) validateSaturday(formats strfmt.Registry) error {
...
func (m *MonitorScheduleWeeklySchedule) validateSunday(formats strfmt.Registry) error {
...
func (m *MonitorScheduleWeeklySchedule) validateThursday(formats strfmt.Registry) error {
...
func (m *MonitorScheduleWeeklySchedule) validateTuesday(formats strfmt.Registry) error {
...
func (m *MonitorScheduleWeeklySchedule) validateWednesday(formats strfmt.Registry) error {
...
// ContextValidate validate this monitor schedule weekly schedule based on the context it is used
func (m *MonitorScheduleWeeklySchedule) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MonitorScheduleWeeklySchedule) contextValidateFriday(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MonitorScheduleWeeklySchedule) contextValidateMonday(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MonitorScheduleWeeklySchedule) contextValidateSaturday(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MonitorScheduleWeeklySchedule) contextValidateSunday(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MonitorScheduleWeeklySchedule) contextValidateThursday(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MonitorScheduleWeeklySchedule) contextValidateTuesday(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MonitorScheduleWeeklySchedule) contextValidateWednesday(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MonitorScheduleWeeklySchedule) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MonitorScheduleWeeklySchedule) UnmarshalBinary(b []byte) error {
	var res MonitorScheduleWeeklySchedule
