...
func (m *Configv1CreateSLOResponse) validateSLO(formats strfmt.Registry) error {
...
func (m *Configv1CreateSLOResponse) contextValidateSLO(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1CreateSLOResponse) UnmarshalBinary(b []byte) error {
	var res Configv1CreateSLOResponse
