...
func (m *Configv1UpdateTeamResponse) validateTeam(formats strfmt.Registry) error {
...
func (m *Configv1UpdateTeamResponse) contextValidateTeam(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1UpdateTeamResponse) UnmarshalBinary(b []byte) error {
	var res Configv1UpdateTeamResponse
