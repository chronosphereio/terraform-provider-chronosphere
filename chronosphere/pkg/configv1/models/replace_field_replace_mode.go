...
//   - FIXED_VALUE: Replace the selected content with a fixed string.
...
const (
	...
	// ReplaceFieldReplaceModeFIXEDVALUE captures enum value "FIXED_VALUE"
	ReplaceFieldReplaceModeFIXEDVALUE ReplaceFieldReplaceMode = "FIXED_VALUE"
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["HASH","FIXED_VALUE","MAPPED_VALUE"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
