...
type LogControlRuleReplaceField struct {
	...
	// fixed value
	FixedValue *LogControlRuleReplaceFieldFixedValue `json:"fixed_value,omitempty"`
...
func (m *LogControlRuleReplaceField) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateFixedValue(formats); err != nil {
		res = append(res, err)
	}
...
func (m *LogControlRuleReplaceField) validateFixedValue(formats strfmt.Registry) error {
	if swag.IsZero(m.FixedValue) { // not required
		return nil
	}

	if m.FixedValue != nil {
		if err := m.FixedValue.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("fixed_value")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("fixed_value")
			}
			return err
		}
	}
...
func (m *LogControlRuleReplaceField) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateFixedValue(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *LogControlRuleReplaceField) contextValidateFixedValue(ctx context.Context, formats strfmt.Registry) error {

	if m.FixedValue != nil {
		if err := m.FixedValue.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("fixed_value")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("fixed_value")
