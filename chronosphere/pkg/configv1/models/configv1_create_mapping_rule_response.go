...
func (m *Configv1CreateMappingRuleResponse) validateMappingRule(formats strfmt.Registry) error {
...
func (m *Configv1CreateMappingRuleResponse) contextValidateMappingRule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1CreateMappingRuleResponse) UnmarshalBinary(b []byte) error {
	var res Configv1CreateMappingRuleResponse
