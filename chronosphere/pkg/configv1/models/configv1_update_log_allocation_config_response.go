...
func (m *Configv1UpdateLogAllocationConfigResponse) validateLogAllocationConfig(formats strfmt.Registry) error {
...
func (m *Configv1UpdateLogAllocationConfigResponse) contextValidateLogAllocationConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1UpdateLogAllocationConfigResponse) UnmarshalBinary(b []byte) error {
	var res Configv1UpdateLogAllocationConfigResponse
