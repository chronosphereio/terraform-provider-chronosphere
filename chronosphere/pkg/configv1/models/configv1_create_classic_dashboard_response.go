...
func (m *Configv1CreateClassicDashboardResponse) validateClassicDashboard(formats strfmt.Registry) error {
...
func (m *Configv1CreateClassicDashboardResponse) contextValidateClassicDashboard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1CreateClassicDashboardResponse) UnmarshalBinary(b []byte) error {
	var res Configv1CreateClassicDashboardResponse
