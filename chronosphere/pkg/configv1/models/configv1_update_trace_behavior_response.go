...
func (m *Configv1UpdateTraceBehaviorResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Configv1UpdateTraceBehaviorResponse) validateTraceBehavior(formats strfmt.Registry) error {
...
func (m *Configv1UpdateTraceBehaviorResponse) contextValidateTraceBehavior(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1UpdateTraceBehaviorResponse) UnmarshalBinary(b []byte) error {
	var res Configv1UpdateTraceBehaviorResponse
