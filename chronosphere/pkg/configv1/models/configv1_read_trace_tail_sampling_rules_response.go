...
func (m *Configv1ReadTraceTailSamplingRulesResponse) validateTraceTailSamplingRules(formats strfmt.Registry) error {
...
func (m *Configv1ReadTraceTailSamplingRulesResponse) contextValidateTraceTailSamplingRules(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1ReadTraceTailSamplingRulesResponse) UnmarshalBinary(b []byte) error {
	var res Configv1ReadTraceTailSamplingRulesResponse
