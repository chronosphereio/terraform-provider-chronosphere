...
func (m *Configv1UpdateConsumptionBudgetResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Configv1UpdateConsumptionBudgetResponse) validateConsumptionBudget(formats strfmt.Registry) error {
...
func (m *Configv1UpdateConsumptionBudgetResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Configv1UpdateConsumptionBudgetResponse) contextValidateConsumptionBudget(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1UpdateConsumptionBudgetResponse) UnmarshalBinary(b []byte) error {
	var res Configv1UpdateConsumptionBudgetResponse
