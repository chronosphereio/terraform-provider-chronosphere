...
func (m *Configv1ReadClassicDashboardResponse) validateClassicDashboard(formats strfmt.Registry) error {
...
func (m *Configv1ReadClassicDashboardResponse) contextValidateClassicDashboard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1ReadClassicDashboardResponse) UnmarshalBinary(b []byte) error {
	var res Configv1ReadClassicDashboardResponse
