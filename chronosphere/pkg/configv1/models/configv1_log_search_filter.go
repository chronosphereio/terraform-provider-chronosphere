...
type Configv1LogSearchFilter struct {
	...
	// Returns logs matching the defined query.
	// The query can include only top-level operations and does not support nested clauses.
	// Accepts one of `AND` or `OR` as an operator.
