...
func (m *Configv1UpdateNotificationPolicyResponse) validateNotificationPolicy(formats strfmt.Registry) error {
...
func (m *Configv1UpdateNotificationPolicyResponse) contextValidateNotificationPolicy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1UpdateNotificationPolicyResponse) UnmarshalBinary(b []byte) error {
	var res Configv1UpdateNotificationPolicyResponse
