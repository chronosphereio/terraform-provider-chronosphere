...
func (m *Configv1ReadRollupRuleResponse) validateRollupRule(formats strfmt.Registry) error {
...
func (m *Configv1ReadRollupRuleResponse) contextValidateRollupRule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1ReadRollupRuleResponse) UnmarshalBinary(b []byte) error {
	var res Configv1ReadRollupRuleResponse
