...
func (m *Configv1ReadExternalConnectionResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Configv1ReadExternalConnectionResponse) validateExternalConnection(formats strfmt.Registry) error {
...
func (m *Configv1ReadExternalConnectionResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Configv1ReadExternalConnectionResponse) contextValidateExternalConnection(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1ReadExternalConnectionResponse) UnmarshalBinary(b []byte) error {
	var res Configv1ReadExternalConnectionResponse
