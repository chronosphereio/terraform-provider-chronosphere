...
func (m *Configv1UpdateLogScaleAlertResponse) validateLogScaleAlert(formats strfmt.Registry) error {
...
func (m *Configv1UpdateLogScaleAlertResponse) contextValidateLogScaleAlert(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1UpdateLogScaleAlertResponse) UnmarshalBinary(b []byte) error {
	var res Configv1UpdateLogScaleAlertResponse
