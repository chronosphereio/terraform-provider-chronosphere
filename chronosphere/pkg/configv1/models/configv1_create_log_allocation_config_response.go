...
func (m *Configv1CreateLogAllocationConfigResponse) validateLogAllocationConfig(formats strfmt.Registry) error {
...
func (m *Configv1CreateLogAllocationConfigResponse) contextValidateLogAllocationConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1CreateLogAllocationConfigResponse) UnmarshalBinary(b []byte) error {
	var res Configv1CreateLogAllocationConfigResponse
