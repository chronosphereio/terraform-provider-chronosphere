...
func (m *Configv1CreateTraceJaegerRemoteSamplingStrategyResponse) validateTraceJaegerRemoteSamplingStrategy(formats strfmt.Registry) error {
...
func (m *Configv1CreateTraceJaegerRemoteSamplingStrategyResponse) contextValidateTraceJaegerRemoteSamplingStrategy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1CreateTraceJaegerRemoteSamplingStrategyResponse) UnmarshalBinary(b []byte) error {
	var res Configv1CreateTraceJaegerRemoteSamplingStrategyResponse
