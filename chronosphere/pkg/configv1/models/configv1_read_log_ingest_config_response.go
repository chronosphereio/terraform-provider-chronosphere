...
func (m *Configv1ReadLogIngestConfigResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Configv1ReadLogIngestConfigResponse) validateLogIngestConfig(formats strfmt.Registry) error {
...
func (m *Configv1ReadLogIngestConfigResponse) contextValidateLogIngestConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1ReadLogIngestConfigResponse) UnmarshalBinary(b []byte) error {
	var res Configv1ReadLogIngestConfigResponse
