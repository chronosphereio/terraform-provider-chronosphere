...
func (m *EmitMetricsCounter) validateValue(formats strfmt.Registry) error {
...
func (m *EmitMetricsCounter) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
