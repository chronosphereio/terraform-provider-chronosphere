...
func (m *Configv1ReadNotificationPolicyResponse) validateNotificationPolicy(formats strfmt.Registry) error {
...
func (m *Configv1ReadNotificationPolicyResponse) contextValidateNotificationPolicy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1ReadNotificationPolicyResponse) UnmarshalBinary(b []byte) error {
	var res Configv1ReadNotificationPolicyResponse
