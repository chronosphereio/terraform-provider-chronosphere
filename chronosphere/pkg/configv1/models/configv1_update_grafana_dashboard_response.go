...
func (m *Configv1UpdateGrafanaDashboardResponse) validateGrafanaDashboard(formats strfmt.Registry) error {
...
func (m *Configv1UpdateGrafanaDashboardResponse) contextValidateGrafanaDashboard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1UpdateGrafanaDashboardResponse) UnmarshalBinary(b []byte) error {
	var res Configv1UpdateGrafanaDashboardResponse
