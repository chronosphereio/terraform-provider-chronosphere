...
func (m *Configv1CreateMutingRuleResponse) validateMutingRule(formats strfmt.Registry) error {
...
func (m *Configv1CreateMutingRuleResponse) contextValidateMutingRule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Configv1CreateMutingRuleResponse) UnmarshalBinary(b []byte) error {
	var res Configv1CreateMutingRuleResponse
