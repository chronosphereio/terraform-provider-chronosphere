...
/*
UpdateClassicDashboardBody update classic dashboard body
swagger:model UpdateClassicDashboardBody
*/
...
func (o *UpdateClassicDashboardBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateClassicDashboard(formats); err != nil {
		res = append(res, err)
	}
...
func (o *UpdateClassicDashboardBody) validateClassicDashboard(formats strfmt.Registry) error {
	if swag.IsZero(o.ClassicDashboard) { // not required
		return nil
	}

	if o.ClassicDashboard != nil {
		if err := o.ClassicDashboard.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("body" + "." + "classic_dashboard")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("body" + "." + "classic_dashboard")
			}
			return err
		}
	}
...
func (o *UpdateClassicDashboardBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := o.contextValidateClassicDashboard(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *UpdateClassicDashboardBody) contextValidateClassicDashboard(ctx context.Context, formats strfmt.Registry) error {

	if o.ClassicDashboard != nil {
		if err := o.ClassicDashboard.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("body" + "." + "classic_dashboard")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("body" + "." + "classic_dashboard")
...
func (o *UpdateClassicDashboardBody) UnmarshalBinary(b []byte) error {
	var res UpdateClassicDashboardBody
