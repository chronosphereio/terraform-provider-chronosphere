...
type ListConsumptionBudgetsOK struct {
	Payload *models.Configv1ListConsumptionBudgetsResponse
}
...
func (o *ListConsumptionBudgetsOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/consumption-budgets][%d] listConsumptionBudgetsOK  %+v", 200, o.Payload)
}
...
func (o *ListConsumptionBudgetsOK) GetPayload() *models.Configv1ListConsumptionBudgetsResponse {
	return o.Payload
}
...
func (o *ListConsumptionBudgetsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Configv1ListConsumptionBudgetsResponse)
...
func (o *ListConsumptionBudgetsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/consumption-budgets][%d] listConsumptionBudgetsInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ListConsumptionBudgetsDefault) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/consumption-budgets][%d] ListConsumptionBudgets default  %+v", o._statusCode, o.Payload)
}
