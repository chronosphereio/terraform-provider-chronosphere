...
func (o *ListMutingRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListMutingRulesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 500:
		result := NewListMutingRulesInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		result := NewListMutingRulesDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *ListMutingRulesOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/muting-rules][%d] listMutingRulesOK  %+v", 200, o.Payload)
}
...
func (o *ListMutingRulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.Configv1ListMutingRulesResponse)
...
func NewListMutingRulesInternalServerError() *ListMutingRulesInternalServerError {
	return &ListMutingRulesInternalServerError{}
}
...
func (o *ListMutingRulesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/muting-rules][%d] listMutingRulesInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ListMutingRulesInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *ListMutingRulesDefault) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/muting-rules][%d] ListMutingRules default  %+v", o._statusCode, o.Payload)
}
...
func (o *ListMutingRulesDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
