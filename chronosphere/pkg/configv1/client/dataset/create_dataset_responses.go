...
type CreateDatasetOK struct {
	Payload *models.Configv1CreateDatasetResponse
}
...
func (o *CreateDatasetOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/datasets][%d] createDatasetOK  %+v", 200, o.Payload)
}
...
func (o *CreateDatasetOK) GetPayload() *models.Configv1CreateDatasetResponse {
	return o.Payload
}
...
func (o *CreateDatasetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Configv1CreateDatasetResponse)
...
func (o *CreateDatasetBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/datasets][%d] createDatasetBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateDatasetConflict) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/datasets][%d] createDatasetConflict  %+v", 409, o.Payload)
}
...
func (o *CreateDatasetInternalServerError) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/datasets][%d] createDatasetInternalServerError  %+v", 500, o.Payload)
}
...
func (o *CreateDatasetDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/datasets][%d] CreateDataset default  %+v", o._statusCode, o.Payload)
}
