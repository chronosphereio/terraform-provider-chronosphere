...
// NewUpdateLogControlConfigParams creates a new UpdateLogControlConfigParams object,
...
func NewUpdateLogControlConfigParams() *UpdateLogControlConfigParams {
	return &UpdateLogControlConfigParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewUpdateLogControlConfigParamsWithTimeout creates a new UpdateLogControlConfigParams object
...
// NewUpdateLogControlConfigParamsWithContext creates a new UpdateLogControlConfigParams object
...
// NewUpdateLogControlConfigParamsWithHTTPClient creates a new UpdateLogControlConfigParams object
...
func (o *UpdateLogControlConfigParams) WithBody(body *models.Configv1UpdateLogControlConfigRequest) *UpdateLogControlConfigParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update log control config params
func (o *UpdateLogControlConfigParams) SetBody(body *models.Configv1UpdateLogControlConfigRequest) {
	o.Body = body
}
