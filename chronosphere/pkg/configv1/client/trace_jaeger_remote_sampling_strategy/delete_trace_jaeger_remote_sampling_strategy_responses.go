...
func (o *DeleteTraceJaegerRemoteSamplingStrategyOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/config/trace-jaeger-remote-sampling-strategies/{slug}][%d] deleteTraceJaegerRemoteSamplingStrategyOK  %+v", 200, o.Payload)
}
...
func (o *DeleteTraceJaegerRemoteSamplingStrategyOK) GetPayload() models.Configv1DeleteTraceJaegerRemoteSamplingStrategyResponse {
	return o.Payload
}
...
func (o *DeleteTraceJaegerRemoteSamplingStrategyBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/config/trace-jaeger-remote-sampling-strategies/{slug}][%d] deleteTraceJaegerRemoteSamplingStrategyBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteTraceJaegerRemoteSamplingStrategyNotFound) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/config/trace-jaeger-remote-sampling-strategies/{slug}][%d] deleteTraceJaegerRemoteSamplingStrategyNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteTraceJaegerRemoteSamplingStrategyInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/config/trace-jaeger-remote-sampling-strategies/{slug}][%d] deleteTraceJaegerRemoteSamplingStrategyInternalServerError  %+v", 500, o.Payload)
}
...
func (o *DeleteTraceJaegerRemoteSamplingStrategyDefault) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/config/trace-jaeger-remote-sampling-strategies/{slug}][%d] DeleteTraceJaegerRemoteSamplingStrategy default  %+v", o._statusCode, o.Payload)
}
