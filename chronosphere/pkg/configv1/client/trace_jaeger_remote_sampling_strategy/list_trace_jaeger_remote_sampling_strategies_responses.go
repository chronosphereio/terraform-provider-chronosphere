...
func (o *ListTraceJaegerRemoteSamplingStrategiesOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/trace-jaeger-remote-sampling-strategies][%d] listTraceJaegerRemoteSamplingStrategiesOK  %+v", 200, o.Payload)
}
...
func (o *ListTraceJaegerRemoteSamplingStrategiesOK) GetPayload() *models.Configv1ListTraceJaegerRemoteSamplingStrategiesResponse {
	return o.Payload
}
...
func (o *ListTraceJaegerRemoteSamplingStrategiesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Configv1ListTraceJaegerRemoteSamplingStrategiesResponse)
...
func (o *ListTraceJaegerRemoteSamplingStrategiesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/trace-jaeger-remote-sampling-strategies][%d] listTraceJaegerRemoteSamplingStrategiesInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ListTraceJaegerRemoteSamplingStrategiesDefault) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/trace-jaeger-remote-sampling-strategies][%d] ListTraceJaegerRemoteSamplingStrategies default  %+v", o._statusCode, o.Payload)
}
