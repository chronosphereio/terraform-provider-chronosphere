...
func (o *UpdateLogScaleAlertParams) WithBody(body *models.ConfigV1UpdateLogScaleAlertBody) *UpdateLogScaleAlertParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update log scale alert params
func (o *UpdateLogScaleAlertParams) SetBody(body *models.ConfigV1UpdateLogScaleAlertBody) {
	o.Body = body
}
