...
func (o *CreateTraceMetricsRuleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateTraceMetricsRuleOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewCreateTraceMetricsRuleBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 409:
		result := NewCreateTraceMetricsRuleConflict()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewCreateTraceMetricsRuleInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		result := NewCreateTraceMetricsRuleDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewCreateTraceMetricsRuleOK() *CreateTraceMetricsRuleOK {
	return &CreateTraceMetricsRuleOK{}
}
...
func (o *CreateTraceMetricsRuleOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/trace-metrics-rules][%d] createTraceMetricsRuleOK  %+v", 200, o.Payload)
}
...
func (o *CreateTraceMetricsRuleOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.Configv1CreateTraceMetricsRuleResponse)
...
func NewCreateTraceMetricsRuleBadRequest() *CreateTraceMetricsRuleBadRequest {
	return &CreateTraceMetricsRuleBadRequest{}
}
...
func (o *CreateTraceMetricsRuleBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/trace-metrics-rules][%d] createTraceMetricsRuleBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateTraceMetricsRuleBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCreateTraceMetricsRuleConflict() *CreateTraceMetricsRuleConflict {
	return &CreateTraceMetricsRuleConflict{}
}
...
func (o *CreateTraceMetricsRuleConflict) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/trace-metrics-rules][%d] createTraceMetricsRuleConflict  %+v", 409, o.Payload)
}
...
func (o *CreateTraceMetricsRuleConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCreateTraceMetricsRuleInternalServerError() *CreateTraceMetricsRuleInternalServerError {
	return &CreateTraceMetricsRuleInternalServerError{}
}
...
func (o *CreateTraceMetricsRuleInternalServerError) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/trace-metrics-rules][%d] createTraceMetricsRuleInternalServerError  %+v", 500, o.Payload)
}
...
func (o *CreateTraceMetricsRuleInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCreateTraceMetricsRuleDefault(code int) *CreateTraceMetricsRuleDefault {
	return &CreateTraceMetricsRuleDefault{
		_statusCode: code,
	}
}
...
func (o *CreateTraceMetricsRuleDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/trace-metrics-rules][%d] CreateTraceMetricsRule default  %+v", o._statusCode, o.Payload)
}
...
func (o *CreateTraceMetricsRuleDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
