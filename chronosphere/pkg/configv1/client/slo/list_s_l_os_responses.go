...
type ListSLOsOK struct {
	Payload *models.Configv1ListSLOsResponse
}
...
func (o *ListSLOsOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/slos][%d] listSLOsOK  %+v", 200, o.Payload)
}
...
func (o *ListSLOsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/slos][%d] listSLOsInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ListSLOsDefault) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/slos][%d] ListSLOs default  %+v", o._statusCode, o.Payload)
}
