...
func (o *CreateSLOOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/slos][%d] createSloOK  %+v", 200, o.Payload)
}
...
func (o *CreateSLOBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/slos][%d] createSloBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateSLOConflict) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/slos][%d] createSloConflict  %+v", 409, o.Payload)
}
...
func (o *CreateSLOInternalServerError) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/slos][%d] createSloInternalServerError  %+v", 500, o.Payload)
}
...
func (o *CreateSLODefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/slos][%d] CreateSLO default  %+v", o._statusCode, o.Payload)
}
