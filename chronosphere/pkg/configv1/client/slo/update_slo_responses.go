...
type UpdateSLOOK struct {
	Payload *models.Configv1UpdateSLOResponse
}
...
func (o *UpdateSLOOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/slos/{slug}][%d] updateSloOK  %+v", 200, o.Payload)
}
...
func (o *UpdateSLOBadRequest) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/slos/{slug}][%d] updateSloBadRequest  %+v", 400, o.Payload)
}
...
func (o *UpdateSLONotFound) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/slos/{slug}][%d] updateSloNotFound  %+v", 404, o.Payload)
}
...
func (o *UpdateSLOConflict) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/slos/{slug}][%d] updateSloConflict  %+v", 409, o.Payload)
}
...
func (o *UpdateSLOInternalServerError) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/slos/{slug}][%d] updateSloInternalServerError  %+v", 500, o.Payload)
}
...
func (o *UpdateSLODefault) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/slos/{slug}][%d] UpdateSLO default  %+v", o._statusCode, o.Payload)
}
