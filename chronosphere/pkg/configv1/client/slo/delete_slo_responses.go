...
type DeleteSLOOK struct {
	Payload models.Configv1DeleteSLOResponse
}
...
func (o *DeleteSLOOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/config/slos/{slug}][%d] deleteSloOK  %+v", 200, o.Payload)
}
...
func (o *DeleteSLOOK) GetPayload() models.Configv1DeleteSLOResponse {
	return o.Payload
}
...
func (o *DeleteSLOBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/config/slos/{slug}][%d] deleteSloBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteSLONotFound) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/config/slos/{slug}][%d] deleteSloNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteSLOInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/config/slos/{slug}][%d] deleteSloInternalServerError  %+v", 500, o.Payload)
}
...
func (o *DeleteSLODefault) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/config/slos/{slug}][%d] DeleteSLO default  %+v", o._statusCode, o.Payload)
}
