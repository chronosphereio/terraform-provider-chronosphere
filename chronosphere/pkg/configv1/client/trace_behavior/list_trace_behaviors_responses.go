...
type ListTraceBehaviorsOK struct {
	Payload *models.Configv1ListTraceBehaviorsResponse
}
...
func (o *ListTraceBehaviorsOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/trace-behaviors][%d] listTraceBehaviorsOK  %+v", 200, o.Payload)
}
...
func (o *ListTraceBehaviorsOK) GetPayload() *models.Configv1ListTraceBehaviorsResponse {
	return o.Payload
}
...
func (o *ListTraceBehaviorsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Configv1ListTraceBehaviorsResponse)
...
func (o *ListTraceBehaviorsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/trace-behaviors][%d] listTraceBehaviorsInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ListTraceBehaviorsDefault) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/trace-behaviors][%d] ListTraceBehaviors default  %+v", o._statusCode, o.Payload)
}
