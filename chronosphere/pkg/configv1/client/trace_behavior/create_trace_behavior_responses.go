...
type CreateTraceBehaviorOK struct {
	Payload *models.Configv1CreateTraceBehaviorResponse
}
...
func (o *CreateTraceBehaviorOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/trace-behaviors][%d] createTraceBehaviorOK  %+v", 200, o.Payload)
}
...
func (o *CreateTraceBehaviorOK) GetPayload() *models.Configv1CreateTraceBehaviorResponse {
	return o.Payload
}
...
func (o *CreateTraceBehaviorOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Configv1CreateTraceBehaviorResponse)
...
func (o *CreateTraceBehaviorBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/trace-behaviors][%d] createTraceBehaviorBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateTraceBehaviorConflict) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/trace-behaviors][%d] createTraceBehaviorConflict  %+v", 409, o.Payload)
}
...
func (o *CreateTraceBehaviorInternalServerError) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/trace-behaviors][%d] createTraceBehaviorInternalServerError  %+v", 500, o.Payload)
}
...
func (o *CreateTraceBehaviorDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/trace-behaviors][%d] CreateTraceBehavior default  %+v", o._statusCode, o.Payload)
}
