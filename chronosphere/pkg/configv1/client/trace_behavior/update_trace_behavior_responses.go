...
type UpdateTraceBehaviorOK struct {
	Payload *models.Configv1UpdateTraceBehaviorResponse
}
...
func (o *UpdateTraceBehaviorOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/trace-behaviors/{slug}][%d] updateTraceBehaviorOK  %+v", 200, o.Payload)
}
...
func (o *UpdateTraceBehaviorOK) GetPayload() *models.Configv1UpdateTraceBehaviorResponse {
	return o.Payload
}
...
func (o *UpdateTraceBehaviorOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Configv1UpdateTraceBehaviorResponse)
...
func (o *UpdateTraceBehaviorBadRequest) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/trace-behaviors/{slug}][%d] updateTraceBehaviorBadRequest  %+v", 400, o.Payload)
}
...
func (o *UpdateTraceBehaviorNotFound) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/trace-behaviors/{slug}][%d] updateTraceBehaviorNotFound  %+v", 404, o.Payload)
}
...
func (o *UpdateTraceBehaviorConflict) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/trace-behaviors/{slug}][%d] updateTraceBehaviorConflict  %+v", 409, o.Payload)
}
...
func (o *UpdateTraceBehaviorInternalServerError) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/trace-behaviors/{slug}][%d] updateTraceBehaviorInternalServerError  %+v", 500, o.Payload)
}
...
func (o *UpdateTraceBehaviorDefault) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/trace-behaviors/{slug}][%d] UpdateTraceBehavior default  %+v", o._statusCode, o.Payload)
}
