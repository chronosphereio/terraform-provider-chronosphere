...
func (o *CreateTraceBehaviorParams) WithBody(body *models.Configv1CreateTraceBehaviorRequest) *CreateTraceBehaviorParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create trace behavior params
func (o *CreateTraceBehaviorParams) SetBody(body *models.Configv1CreateTraceBehaviorRequest) {
	o.Body = body
}
