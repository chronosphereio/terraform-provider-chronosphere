...
func (o *UpdateTraceBehaviorParams) WithBody(body *models.ConfigV1UpdateTraceBehaviorBody) *UpdateTraceBehaviorParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update trace behavior params
func (o *UpdateTraceBehaviorParams) SetBody(body *models.ConfigV1UpdateTraceBehaviorBody) {
	o.Body = body
}
