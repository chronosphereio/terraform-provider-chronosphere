...
func (o *DeleteTraceTailSamplingRulesOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/config/trace-tail-sampling-rules][%d] deleteTraceTailSamplingRulesOK  %+v", 200, o.Payload)
}
...
func (o *DeleteTraceTailSamplingRulesOK) GetPayload() models.Configv1DeleteTraceTailSamplingRulesResponse {
	return o.Payload
}
...
func (o *DeleteTraceTailSamplingRulesNotFound) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/config/trace-tail-sampling-rules][%d] deleteTraceTailSamplingRulesNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteTraceTailSamplingRulesInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/config/trace-tail-sampling-rules][%d] deleteTraceTailSamplingRulesInternalServerError  %+v", 500, o.Payload)
}
...
func (o *DeleteTraceTailSamplingRulesDefault) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/config/trace-tail-sampling-rules][%d] DeleteTraceTailSamplingRules default  %+v", o._statusCode, o.Payload)
}
