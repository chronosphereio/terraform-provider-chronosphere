...
// WithSlug adds the slug to the delete cloud integration params
func (o *DeleteCloudIntegrationParams) WithSlug(slug string) *DeleteCloudIntegrationParams {
	o.SetSlug(slug)
	return o
}

// SetSlug adds the slug to the delete cloud integration params
func (o *DeleteCloudIntegrationParams) SetSlug(slug string) {
	o.Slug = slug
}
