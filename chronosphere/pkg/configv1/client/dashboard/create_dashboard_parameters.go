...
func (o *CreateDashboardParams) WithBody(body *models.Configv1CreateDashboardRequest) *CreateDashboardParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create dashboard params
func (o *CreateDashboardParams) SetBody(body *models.Configv1CreateDashboardRequest) {
	o.Body = body
}
