...
func (o *CreateLogAllocationConfigParams) WithBody(body *models.Configv1CreateLogAllocationConfigRequest) *CreateLogAllocationConfigParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create log allocation config params
func (o *CreateLogAllocationConfigParams) SetBody(body *models.Configv1CreateLogAllocationConfigRequest) {
	o.Body = body
}
