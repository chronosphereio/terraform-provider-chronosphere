...
// NewCreateDropRuleParams creates a new CreateDropRuleParams object,
...
func NewCreateDropRuleParams() *CreateDropRuleParams {
	return &CreateDropRuleParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewCreateDropRuleParamsWithTimeout creates a new CreateDropRuleParams object
...
// NewCreateDropRuleParamsWithContext creates a new CreateDropRuleParams object
...
// NewCreateDropRuleParamsWithHTTPClient creates a new CreateDropRuleParams object
...
func (o *CreateDropRuleParams) WithContext(ctx context.Context) *CreateDropRuleParams {
	o.SetContext(ctx)
	return o
}
...
func (o *CreateDropRuleParams) WithBody(body *models.Configv1CreateDropRuleRequest) *CreateDropRuleParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create drop rule params
func (o *CreateDropRuleParams) SetBody(body *models.Configv1CreateDropRuleRequest) {
	o.Body = body
}
