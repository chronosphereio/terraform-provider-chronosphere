...
func (o *CreateTeamParams) WithBody(body *models.Configv1CreateTeamRequest) *CreateTeamParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create team params
func (o *CreateTeamParams) SetBody(body *models.Configv1CreateTeamRequest) {
	o.Body = body
}
