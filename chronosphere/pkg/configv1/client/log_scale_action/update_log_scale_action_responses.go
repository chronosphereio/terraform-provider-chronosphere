...
func (o *UpdateLogScaleActionOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-actions/{slug}][%d] updateLogScaleActionOK  %+v", 200, o.Payload)
}
...
func (o *UpdateLogScaleActionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Configv1UpdateLogScaleActionResponse)
...
func (o *UpdateLogScaleActionBadRequest) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-actions/{slug}][%d] updateLogScaleActionBadRequest  %+v", 400, o.Payload)
}
...
func (o *UpdateLogScaleActionNotFound) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-actions/{slug}][%d] updateLogScaleActionNotFound  %+v", 404, o.Payload)
}
...
func (o *UpdateLogScaleActionConflict) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-actions/{slug}][%d] updateLogScaleActionConflict  %+v", 409, o.Payload)
}
...
func (o *UpdateLogScaleActionInternalServerError) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-actions/{slug}][%d] updateLogScaleActionInternalServerError  %+v", 500, o.Payload)
}
...
func (o *UpdateLogScaleActionDefault) Error() string {
	return fmt.Sprintf("[PUT /api/v1/config/log-scale-actions/{slug}][%d] UpdateLogScaleAction default  %+v", o._statusCode, o.Payload)
}
