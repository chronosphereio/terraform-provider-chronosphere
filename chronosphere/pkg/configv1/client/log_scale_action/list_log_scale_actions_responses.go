...
func (o *ListLogScaleActionsOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/log-scale-actions][%d] listLogScaleActionsOK  %+v", 200, o.Payload)
}
...
func (o *ListLogScaleActionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Configv1ListLogScaleActionsResponse)
...
func (o *ListLogScaleActionsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/log-scale-actions][%d] listLogScaleActionsInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ListLogScaleActionsDefault) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/log-scale-actions][%d] ListLogScaleActions default  %+v", o._statusCode, o.Payload)
}
