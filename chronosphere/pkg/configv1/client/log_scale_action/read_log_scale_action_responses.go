...
func (o *ReadLogScaleActionOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/log-scale-actions/{slug}][%d] readLogScaleActionOK  %+v", 200, o.Payload)
}
...
func (o *ReadLogScaleActionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Configv1ReadLogScaleActionResponse)
...
func (o *ReadLogScaleActionNotFound) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/log-scale-actions/{slug}][%d] readLogScaleActionNotFound  %+v", 404, o.Payload)
}
...
func (o *ReadLogScaleActionInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/log-scale-actions/{slug}][%d] readLogScaleActionInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ReadLogScaleActionDefault) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/log-scale-actions/{slug}][%d] ReadLogScaleAction default  %+v", o._statusCode, o.Payload)
}
