...
func (o *CreateLogScaleActionOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/log-scale-actions][%d] createLogScaleActionOK  %+v", 200, o.Payload)
}
...
func (o *CreateLogScaleActionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Configv1CreateLogScaleActionResponse)
...
func (o *CreateLogScaleActionBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/log-scale-actions][%d] createLogScaleActionBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateLogScaleActionConflict) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/log-scale-actions][%d] createLogScaleActionConflict  %+v", 409, o.Payload)
}
...
func (o *CreateLogScaleActionInternalServerError) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/log-scale-actions][%d] createLogScaleActionInternalServerError  %+v", 500, o.Payload)
}
...
func (o *CreateLogScaleActionDefault) Error() string {
	return fmt.Sprintf("[POST /api/v1/config/log-scale-actions][%d] CreateLogScaleAction default  %+v", o._statusCode, o.Payload)
}
