...
// NewDeleteMappingRuleParams creates a new DeleteMappingRuleParams object,
...
func NewDeleteMappingRuleParams() *DeleteMappingRuleParams {
	return &DeleteMappingRuleParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteMappingRuleParamsWithTimeout creates a new DeleteMappingRuleParams object
...
// NewDeleteMappingRuleParamsWithContext creates a new DeleteMappingRuleParams object
...
// NewDeleteMappingRuleParamsWithHTTPClient creates a new DeleteMappingRuleParams object
...
func (o *DeleteMappingRuleParams) WithDefaults() *DeleteMappingRuleParams {
	o.SetDefaults()
	return o
}
...
func (o *DeleteMappingRuleParams) WithTimeout(timeout time.Duration) *DeleteMappingRuleParams {
...
func (o *DeleteMappingRuleParams) WithContext(ctx context.Context) *DeleteMappingRuleParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DeleteMappingRuleParams) WithSlug(slug string) *DeleteMappingRuleParams {
	o.SetSlug(slug)
	return o
}
...
func (o *DeleteMappingRuleParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
