...
func (o *ListDerivedMetricsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListDerivedMetricsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 500:
		result := NewListDerivedMetricsInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		result := NewListDerivedMetricsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *ListDerivedMetricsOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/derived-metrics][%d] listDerivedMetricsOK  %+v", 200, o.Payload)
}
...
func (o *ListDerivedMetricsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.Configv1ListDerivedMetricsResponse)
...
func NewListDerivedMetricsInternalServerError() *ListDerivedMetricsInternalServerError {
	return &ListDerivedMetricsInternalServerError{}
}
...
func (o *ListDerivedMetricsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/derived-metrics][%d] listDerivedMetricsInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ListDerivedMetricsInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewListDerivedMetricsDefault(code int) *ListDerivedMetricsDefault {
	return &ListDerivedMetricsDefault{
		_statusCode: code,
	}
}
...
func (o *ListDerivedMetricsDefault) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/derived-metrics][%d] ListDerivedMetrics default  %+v", o._statusCode, o.Payload)
}
...
func (o *ListDerivedMetricsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
