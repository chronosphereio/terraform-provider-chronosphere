...
type ListServicesOK struct {
	Payload *models.Configv1ListServicesResponse
}
...
func (o *ListServicesOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/services][%d] listServicesOK  %+v", 200, o.Payload)
}
...
func (o *ListServicesOK) GetPayload() *models.Configv1ListServicesResponse {
	return o.Payload
}
...
func (o *ListServicesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.Configv1ListServicesResponse)
...
func (o *ListServicesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/services][%d] listServicesInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ListServicesDefault) Error() string {
	return fmt.Sprintf("[GET /api/v1/config/services][%d] ListServices default  %+v", o._statusCode, o.Payload)
}
