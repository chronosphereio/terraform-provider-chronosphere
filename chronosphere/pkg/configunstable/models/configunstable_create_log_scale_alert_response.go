...
func (m *ConfigunstableCreateLogScaleAlertResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableCreateLogScaleAlertResponse) validateLogScaleAlert(formats strfmt.Registry) error {
...
func (m *ConfigunstableCreateLogScaleAlertResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableCreateLogScaleAlertResponse) contextValidateLogScaleAlert(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigunstableCreateLogScaleAlertResponse) UnmarshalBinary(b []byte) error {
	var res ConfigunstableCreateLogScaleAlertResponse
