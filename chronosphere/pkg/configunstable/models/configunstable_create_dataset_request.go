...
func (m *ConfigunstableCreateDatasetRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableCreateDatasetRequest) validateDataset(formats strfmt.Registry) error {
...
func (m *ConfigunstableCreateDatasetRequest) contextValidateDataset(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigunstableCreateDatasetRequest) UnmarshalBinary(b []byte) error {
	var res ConfigunstableCreateDatasetRequest
