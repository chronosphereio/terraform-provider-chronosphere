...
type ConfigunstableSLO struct {
	...
	// Optional notification policy to explicitly apply to the generated monitors. If this is not set
	// then the team this SLO will belong to must have a default notification policy
