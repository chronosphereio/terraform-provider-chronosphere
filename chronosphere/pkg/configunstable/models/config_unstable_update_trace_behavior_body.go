...
func (m *ConfigUnstableUpdateTraceBehaviorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigUnstableUpdateTraceBehaviorBody) validateTraceBehavior(formats strfmt.Registry) error {
...
func (m *ConfigUnstableUpdateTraceBehaviorBody) contextValidateTraceBehavior(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigUnstableUpdateTraceBehaviorBody) UnmarshalBinary(b []byte) error {
	var res ConfigUnstableUpdateTraceBehaviorBody
