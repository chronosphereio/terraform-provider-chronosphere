...
func (m *ConfigunstableCreateDatasetResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableCreateDatasetResponse) validateDataset(formats strfmt.Registry) error {
...
func (m *ConfigunstableCreateDatasetResponse) contextValidateDataset(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigunstableCreateDatasetResponse) UnmarshalBinary(b []byte) error {
	var res ConfigunstableCreateDatasetResponse
