...
func (m *ConfigunstableReadSavedTraceSearchResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableReadSavedTraceSearchResponse) validateSavedTraceSearch(formats strfmt.Registry) error {
...
func (m *ConfigunstableReadSavedTraceSearchResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableReadSavedTraceSearchResponse) contextValidateSavedTraceSearch(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigunstableReadSavedTraceSearchResponse) UnmarshalBinary(b []byte) error {
	var res ConfigunstableReadSavedTraceSearchResponse
