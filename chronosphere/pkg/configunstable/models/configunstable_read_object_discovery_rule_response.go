...
func (m *ConfigunstableReadObjectDiscoveryRuleResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableReadObjectDiscoveryRuleResponse) validateObjectDiscoveryRule(formats strfmt.Registry) error {
...
func (m *ConfigunstableReadObjectDiscoveryRuleResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableReadObjectDiscoveryRuleResponse) contextValidateObjectDiscoveryRule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigunstableReadObjectDiscoveryRuleResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ConfigunstableReadObjectDiscoveryRuleResponse) UnmarshalBinary(b []byte) error {
	var res ConfigunstableReadObjectDiscoveryRuleResponse
