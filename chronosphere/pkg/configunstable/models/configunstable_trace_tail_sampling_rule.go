...
func (m *ConfigunstableTraceTailSamplingRule) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableTraceTailSamplingRule) validateFilter(formats strfmt.Registry) error {
...
func (m *ConfigunstableTraceTailSamplingRule) contextValidateFilter(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigunstableTraceTailSamplingRule) UnmarshalBinary(b []byte) error {
	var res ConfigunstableTraceTailSamplingRule
