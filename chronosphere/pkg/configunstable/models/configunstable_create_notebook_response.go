...
func (m *ConfigunstableCreateNotebookResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableCreateNotebookResponse) validateNotebook(formats strfmt.Registry) error {
...
func (m *ConfigunstableCreateNotebookResponse) contextValidateNotebook(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigunstableCreateNotebookResponse) UnmarshalBinary(b []byte) error {
	var res ConfigunstableCreateNotebookResponse
