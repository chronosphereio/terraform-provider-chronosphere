...
type SLIEndpointAvailabilityConfig struct {
	...
	// These are added to _every_ query and are intended to be used for things like `cluster!~"dev"`
	...
	// A list of result codes that indicate an unsuccessful event. Either this or success_codes must be set.
	ErrorCodes []string `json:"error_codes"`

	// A list of result codes that indicate a successful event. Either this or error_codes must be set.
