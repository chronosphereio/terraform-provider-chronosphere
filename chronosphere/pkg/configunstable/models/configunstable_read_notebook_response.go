...
func (m *ConfigunstableReadNotebookResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableReadNotebookResponse) validateNotebook(formats strfmt.Registry) error {
...
func (m *ConfigunstableReadNotebookResponse) contextValidateNotebook(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigunstableReadNotebookResponse) UnmarshalBinary(b []byte) error {
	var res ConfigunstableReadNotebookResponse
