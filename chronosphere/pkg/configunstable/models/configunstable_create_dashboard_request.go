...
func (m *ConfigunstableCreateDashboardRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableCreateDashboardRequest) validateDashboard(formats strfmt.Registry) error {
...
func (m *ConfigunstableCreateDashboardRequest) contextValidateDashboard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigunstableCreateDashboardRequest) UnmarshalBinary(b []byte) error {
	var res ConfigunstableCreateDashboardRequest
