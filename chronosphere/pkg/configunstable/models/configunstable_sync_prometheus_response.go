...
func (m *ConfigunstableSyncPrometheusResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableSyncPrometheusResponse) validateChanges(formats strfmt.Registry) error {
...
func (m *ConfigunstableSyncPrometheusResponse) contextValidateChanges(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigunstableSyncPrometheusResponse) UnmarshalBinary(b []byte) error {
	var res ConfigunstableSyncPrometheusResponse
