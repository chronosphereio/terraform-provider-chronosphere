...
func (m *ConfigunstableCreateDashboardResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableCreateDashboardResponse) validateDashboard(formats strfmt.Registry) error {
...
func (m *ConfigunstableCreateDashboardResponse) contextValidateDashboard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigunstableCreateDashboardResponse) UnmarshalBinary(b []byte) error {
	var res ConfigunstableCreateDashboardResponse
