...
func (m *ConfigUnstableUpdateLogScaleActionBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigUnstableUpdateLogScaleActionBody) validateLogScaleAction(formats strfmt.Registry) error {
...
func (m *ConfigUnstableUpdateLogScaleActionBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigUnstableUpdateLogScaleActionBody) contextValidateLogScaleAction(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigUnstableUpdateLogScaleActionBody) UnmarshalBinary(b []byte) error {
	var res ConfigUnstableUpdateLogScaleActionBody
