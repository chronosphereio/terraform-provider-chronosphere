...
// SLICustomIndicatorConfig CustomIndicatorConfig is for SLIs that are not associated with Chronosphere Lens supported
// SLO types. They are provided with several variables that can be used in the template to
// generate the query:
// - Window (required)
// - GroupBy (required)
...
type SLICustomIndicatorConfig struct {
	...
	// A PromQL query that measures the number of "bad" events for this SLI. Either this or the
	// good_query_template must be set.
	BadQueryTemplate string `json:"bad_query_template,omitempty"`

	// A PromQL query that measures the number of "good" events for this SLI. Either this or the
	// bad_query_template must be set.
	GoodQueryTemplate string `json:"good_query_template,omitempty"`

	// A PromQL query that measures the total number of events for this SLI. This is required for
	// all advanced SLIs.
