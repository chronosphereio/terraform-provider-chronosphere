...
func (m *ConfigunstableSyntheticTest) validateRetryConfig(formats strfmt.Registry) error {
...
func (m *ConfigunstableSyntheticTest) contextValidateRetryConfig(ctx context.Context, formats strfmt.Registry) error {
