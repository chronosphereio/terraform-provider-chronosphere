...
func (m *AzureMetricsIntegrationAzureResourceType) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this azure metrics integration azure resource type based on context it is used
func (m *AzureMetricsIntegrationAzureResourceType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (m *AzureMetricsIntegrationAzureResourceType) UnmarshalBinary(b []byte) error {
	var res AzureMetricsIntegrationAzureResourceType
