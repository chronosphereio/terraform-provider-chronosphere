...
type SLODefinition struct {
	...
	// Configured whether this SLO is for a low volume event (< 1/s). This will adjust the SLI queries
	// to account for the low volume nature of the event.
	LowVolume bool `json:"low_volume,omitempty"`

	// The SLO objective
	Objective float64 `json:"objective,omitempty"`

	// The reporting windows for this SLO. The SLO is considered breached if the error budget is
	// depleted in any of these windows.
