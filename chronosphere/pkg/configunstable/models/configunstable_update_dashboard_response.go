...
func (m *ConfigunstableUpdateDashboardResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ConfigunstableUpdateDashboardResponse) validateDashboard(formats strfmt.Registry) error {
...
func (m *ConfigunstableUpdateDashboardResponse) contextValidateDashboard(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigunstableUpdateDashboardResponse) UnmarshalBinary(b []byte) error {
	var res ConfigunstableUpdateDashboardResponse
