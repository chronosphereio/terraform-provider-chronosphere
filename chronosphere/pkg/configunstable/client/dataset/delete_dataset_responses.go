...
func (o *DeleteDatasetOK) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/datasets/{slug}][%d] deleteDatasetOK  %+v", 200, o.Payload)
}
...
func (o *DeleteDatasetBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/datasets/{slug}][%d] deleteDatasetBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteDatasetNotFound) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/datasets/{slug}][%d] deleteDatasetNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteDatasetInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/datasets/{slug}][%d] deleteDatasetInternalServerError  %+v", 500, o.Payload)
}
...
func (o *DeleteDatasetDefault) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/datasets/{slug}][%d] DeleteDataset default  %+v", o._statusCode, o.Payload)
}
