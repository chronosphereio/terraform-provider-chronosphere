...
func (o *ReadDatasetOK) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/datasets/{slug}][%d] readDatasetOK  %+v", 200, o.Payload)
}
...
func (o *ReadDatasetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableReadDatasetResponse)
...
func (o *ReadDatasetNotFound) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/datasets/{slug}][%d] readDatasetNotFound  %+v", 404, o.Payload)
}
...
func (o *ReadDatasetInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/datasets/{slug}][%d] readDatasetInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ReadDatasetDefault) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/datasets/{slug}][%d] ReadDataset default  %+v", o._statusCode, o.Payload)
}
