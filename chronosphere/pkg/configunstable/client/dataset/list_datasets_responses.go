...
func (o *ListDatasetsOK) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/datasets][%d] listDatasetsOK  %+v", 200, o.Payload)
}
...
func (o *ListDatasetsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableListDatasetsResponse)
...
func (o *ListDatasetsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/datasets][%d] listDatasetsInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ListDatasetsDefault) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/datasets][%d] ListDatasets default  %+v", o._statusCode, o.Payload)
}
