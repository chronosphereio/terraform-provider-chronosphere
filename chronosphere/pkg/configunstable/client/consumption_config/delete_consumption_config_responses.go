...
type DeleteConsumptionConfigOK struct {
	Payload models.ConfigunstableDeleteConsumptionConfigResponse
}
...
func (o *DeleteConsumptionConfigOK) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/consumption-config][%d] deleteConsumptionConfigOK  %+v", 200, o.Payload)
}
...
func (o *DeleteConsumptionConfigOK) GetPayload() models.ConfigunstableDeleteConsumptionConfigResponse {
	return o.Payload
}
...
func (o *DeleteConsumptionConfigBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/consumption-config][%d] deleteConsumptionConfigBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteConsumptionConfigNotFound) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/consumption-config][%d] deleteConsumptionConfigNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteConsumptionConfigInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/consumption-config][%d] deleteConsumptionConfigInternalServerError  %+v", 500, o.Payload)
}
...
func (o *DeleteConsumptionConfigDefault) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/consumption-config][%d] DeleteConsumptionConfig default  %+v", o._statusCode, o.Payload)
}
