...
func (o *CreateTraceJaegerRemoteSamplingStrategyOK) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/trace-jaeger-remote-sampling-strategies][%d] createTraceJaegerRemoteSamplingStrategyOK  %+v", 200, o.Payload)
}
...
func (o *CreateTraceJaegerRemoteSamplingStrategyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableCreateTraceJaegerRemoteSamplingStrategyResponse)
...
func (o *CreateTraceJaegerRemoteSamplingStrategyBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/trace-jaeger-remote-sampling-strategies][%d] createTraceJaegerRemoteSamplingStrategyBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateTraceJaegerRemoteSamplingStrategyConflict) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/trace-jaeger-remote-sampling-strategies][%d] createTraceJaegerRemoteSamplingStrategyConflict  %+v", 409, o.Payload)
}
...
func (o *CreateTraceJaegerRemoteSamplingStrategyInternalServerError) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/trace-jaeger-remote-sampling-strategies][%d] createTraceJaegerRemoteSamplingStrategyInternalServerError  %+v", 500, o.Payload)
}
...
func (o *CreateTraceJaegerRemoteSamplingStrategyDefault) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/trace-jaeger-remote-sampling-strategies][%d] CreateTraceJaegerRemoteSamplingStrategy default  %+v", o._statusCode, o.Payload)
}
