...
func (o *DeleteLogScaleActionOK) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-scale-actions/{slug}][%d] deleteLogScaleActionOK  %+v", 200, o.Payload)
}
...
func (o *DeleteLogScaleActionBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-scale-actions/{slug}][%d] deleteLogScaleActionBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteLogScaleActionNotFound) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-scale-actions/{slug}][%d] deleteLogScaleActionNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteLogScaleActionInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-scale-actions/{slug}][%d] deleteLogScaleActionInternalServerError  %+v", 500, o.Payload)
}
...
func (o *DeleteLogScaleActionDefault) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-scale-actions/{slug}][%d] DeleteLogScaleAction default  %+v", o._statusCode, o.Payload)
}
