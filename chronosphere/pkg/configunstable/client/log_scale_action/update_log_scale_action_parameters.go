...
func (o *UpdateLogScaleActionParams) WithBody(body UpdateLogScaleActionBody) *UpdateLogScaleActionParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update log scale action params
func (o *UpdateLogScaleActionParams) SetBody(body UpdateLogScaleActionBody) {
	o.Body = body
}
