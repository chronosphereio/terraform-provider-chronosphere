...
func (o *ListDashboardsOK) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/dashboards][%d] listDashboardsOK  %+v", 200, o.Payload)
}
...
func (o *ListDashboardsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableListDashboardsResponse)
...
func (o *ListDashboardsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/dashboards][%d] listDashboardsInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ListDashboardsDefault) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/dashboards][%d] ListDashboards default  %+v", o._statusCode, o.Payload)
}
