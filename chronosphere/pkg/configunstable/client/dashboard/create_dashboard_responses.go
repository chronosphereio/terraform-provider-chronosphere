...
func (o *CreateDashboardOK) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/dashboards][%d] createDashboardOK  %+v", 200, o.Payload)
}
...
func (o *CreateDashboardOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableCreateDashboardResponse)
...
func (o *CreateDashboardBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/dashboards][%d] createDashboardBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateDashboardConflict) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/dashboards][%d] createDashboardConflict  %+v", 409, o.Payload)
}
...
func (o *CreateDashboardInternalServerError) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/dashboards][%d] createDashboardInternalServerError  %+v", 500, o.Payload)
}
...
func (o *CreateDashboardDefault) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/dashboards][%d] CreateDashboard default  %+v", o._statusCode, o.Payload)
}
