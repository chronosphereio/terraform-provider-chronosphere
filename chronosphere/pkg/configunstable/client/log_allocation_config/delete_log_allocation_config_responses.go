...
func (o *DeleteLogAllocationConfigOK) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-allocation-config][%d] deleteLogAllocationConfigOK  %+v", 200, o.Payload)
}
...
func (o *DeleteLogAllocationConfigBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-allocation-config][%d] deleteLogAllocationConfigBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteLogAllocationConfigNotFound) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-allocation-config][%d] deleteLogAllocationConfigNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteLogAllocationConfigInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-allocation-config][%d] deleteLogAllocationConfigInternalServerError  %+v", 500, o.Payload)
}
...
func (o *DeleteLogAllocationConfigDefault) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-allocation-config][%d] DeleteLogAllocationConfig default  %+v", o._statusCode, o.Payload)
}
