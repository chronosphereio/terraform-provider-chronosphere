...
func (o *CreateLogAllocationConfigOK) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/log-allocation-config][%d] createLogAllocationConfigOK  %+v", 200, o.Payload)
}
...
func (o *CreateLogAllocationConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableCreateLogAllocationConfigResponse)
...
func (o *CreateLogAllocationConfigBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/log-allocation-config][%d] createLogAllocationConfigBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateLogAllocationConfigConflict) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/log-allocation-config][%d] createLogAllocationConfigConflict  %+v", 409, o.Payload)
}
...
func (o *CreateLogAllocationConfigInternalServerError) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/log-allocation-config][%d] createLogAllocationConfigInternalServerError  %+v", 500, o.Payload)
}
...
func (o *CreateLogAllocationConfigDefault) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/log-allocation-config][%d] CreateLogAllocationConfig default  %+v", o._statusCode, o.Payload)
}
