...
func (o *ReadLogAllocationConfigOK) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/log-allocation-config][%d] readLogAllocationConfigOK  %+v", 200, o.Payload)
}
...
func (o *ReadLogAllocationConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableReadLogAllocationConfigResponse)
...
func (o *ReadLogAllocationConfigNotFound) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/log-allocation-config][%d] readLogAllocationConfigNotFound  %+v", 404, o.Payload)
}
...
func (o *ReadLogAllocationConfigInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/log-allocation-config][%d] readLogAllocationConfigInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ReadLogAllocationConfigDefault) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/log-allocation-config][%d] ReadLogAllocationConfig default  %+v", o._statusCode, o.Payload)
}
