...
func (o *UpdateLogAllocationConfigOK) Error() string {
	return fmt.Sprintf("[PUT /api/unstable/config/log-allocation-config][%d] updateLogAllocationConfigOK  %+v", 200, o.Payload)
}
...
func (o *UpdateLogAllocationConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableUpdateLogAllocationConfigResponse)
...
func (o *UpdateLogAllocationConfigBadRequest) Error() string {
	return fmt.Sprintf("[PUT /api/unstable/config/log-allocation-config][%d] updateLogAllocationConfigBadRequest  %+v", 400, o.Payload)
}
...
func (o *UpdateLogAllocationConfigNotFound) Error() string {
	return fmt.Sprintf("[PUT /api/unstable/config/log-allocation-config][%d] updateLogAllocationConfigNotFound  %+v", 404, o.Payload)
}
...
func (o *UpdateLogAllocationConfigInternalServerError) Error() string {
	return fmt.Sprintf("[PUT /api/unstable/config/log-allocation-config][%d] updateLogAllocationConfigInternalServerError  %+v", 500, o.Payload)
}
...
func (o *UpdateLogAllocationConfigDefault) Error() string {
	return fmt.Sprintf("[PUT /api/unstable/config/log-allocation-config][%d] UpdateLogAllocationConfig default  %+v", o._statusCode, o.Payload)
}
