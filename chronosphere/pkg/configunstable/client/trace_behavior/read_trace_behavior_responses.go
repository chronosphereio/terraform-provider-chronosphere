...
func (o *ReadTraceBehaviorOK) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/trace-behaviors/{slug}][%d] readTraceBehaviorOK  %+v", 200, o.Payload)
}
...
func (o *ReadTraceBehaviorOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableReadTraceBehaviorResponse)
...
func (o *ReadTraceBehaviorNotFound) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/trace-behaviors/{slug}][%d] readTraceBehaviorNotFound  %+v", 404, o.Payload)
}
...
func (o *ReadTraceBehaviorInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/trace-behaviors/{slug}][%d] readTraceBehaviorInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ReadTraceBehaviorDefault) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/trace-behaviors/{slug}][%d] ReadTraceBehavior default  %+v", o._statusCode, o.Payload)
}
