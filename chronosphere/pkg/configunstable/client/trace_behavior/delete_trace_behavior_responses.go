...
func (o *DeleteTraceBehaviorOK) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/trace-behaviors/{slug}][%d] deleteTraceBehaviorOK  %+v", 200, o.Payload)
}
...
func (o *DeleteTraceBehaviorBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/trace-behaviors/{slug}][%d] deleteTraceBehaviorBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteTraceBehaviorNotFound) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/trace-behaviors/{slug}][%d] deleteTraceBehaviorNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteTraceBehaviorInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/trace-behaviors/{slug}][%d] deleteTraceBehaviorInternalServerError  %+v", 500, o.Payload)
}
...
func (o *DeleteTraceBehaviorDefault) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/trace-behaviors/{slug}][%d] DeleteTraceBehavior default  %+v", o._statusCode, o.Payload)
}
