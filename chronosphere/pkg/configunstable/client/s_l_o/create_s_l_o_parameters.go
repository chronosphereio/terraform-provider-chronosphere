...
CreateSLOParams contains all the parameters to send to the API endpoint
	...
	for the create s l o operation.
...
// WithDefaults hydrates default values in the create s l o params (not the query body).
//
...
// SetDefaults hydrates default values in the create s l o params (not the query body).
//
// All values with no default are reset to their zero value.
