...
// WithDefaults hydrates default values in the read s l o params (not the query body).
//
...
// SetDefaults hydrates default values in the read s l o params (not the query body).
//
// All values with no default are reset to their zero value.
