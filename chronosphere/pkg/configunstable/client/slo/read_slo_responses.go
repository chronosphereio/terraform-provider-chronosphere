...
func (o *ReadSLOOK) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/slos/{slug}][%d] readSloOK  %+v", 200, o.Payload)
}
...
func (o *ReadSLOOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableReadSLOResponse)
...
func (o *ReadSLONotFound) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/slos/{slug}][%d] readSloNotFound  %+v", 404, o.Payload)
}
...
func (o *ReadSLOInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/slos/{slug}][%d] readSloInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ReadSLODefault) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/slos/{slug}][%d] ReadSLO default  %+v", o._statusCode, o.Payload)
}
