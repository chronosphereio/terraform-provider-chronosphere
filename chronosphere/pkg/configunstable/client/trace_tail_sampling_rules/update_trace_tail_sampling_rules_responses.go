...
func (o *UpdateTraceTailSamplingRulesBadRequest) Error() string {
	return fmt.Sprintf("[PUT /api/unstable/config/trace-tail-sampling-rules][%d] updateTraceTailSamplingRulesBadRequest  %+v", 400, o.Payload)
}
...
func (o *UpdateTraceTailSamplingRulesNotFound) Error() string {
	return fmt.Sprintf("[PUT /api/unstable/config/trace-tail-sampling-rules][%d] updateTraceTailSamplingRulesNotFound  %+v", 404, o.Payload)
}
...
func (o *UpdateTraceTailSamplingRulesInternalServerError) Error() string {
	return fmt.Sprintf("[PUT /api/unstable/config/trace-tail-sampling-rules][%d] updateTraceTailSamplingRulesInternalServerError  %+v", 500, o.Payload)
}
