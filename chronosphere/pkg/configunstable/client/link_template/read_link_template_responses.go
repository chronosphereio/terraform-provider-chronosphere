...
func (o *ReadLinkTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewReadLinkTemplateOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 404:
		result := NewReadLinkTemplateNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewReadLinkTemplateInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		result := NewReadLinkTemplateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *ReadLinkTemplateOK) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/link-templates/{slug}][%d] readLinkTemplateOK  %+v", 200, o.Payload)
}
...
func (o *ReadLinkTemplateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ConfigunstableReadLinkTemplateResponse)
...
func NewReadLinkTemplateNotFound() *ReadLinkTemplateNotFound {
	return &ReadLinkTemplateNotFound{}
}
...
func (o *ReadLinkTemplateNotFound) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/link-templates/{slug}][%d] readLinkTemplateNotFound  %+v", 404, o.Payload)
}
...
func (o *ReadLinkTemplateNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewReadLinkTemplateInternalServerError() *ReadLinkTemplateInternalServerError {
	return &ReadLinkTemplateInternalServerError{}
}
...
func (o *ReadLinkTemplateInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/link-templates/{slug}][%d] readLinkTemplateInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ReadLinkTemplateInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewReadLinkTemplateDefault(code int) *ReadLinkTemplateDefault {
	return &ReadLinkTemplateDefault{
		_statusCode: code,
	}
}
...
func (o *ReadLinkTemplateDefault) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/link-templates/{slug}][%d] ReadLinkTemplate default  %+v", o._statusCode, o.Payload)
}
...
func (o *ReadLinkTemplateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
