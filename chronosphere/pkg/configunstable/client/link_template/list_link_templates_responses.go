...
func (o *ListLinkTemplatesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListLinkTemplatesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 500:
		result := NewListLinkTemplatesInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		result := NewListLinkTemplatesDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *ListLinkTemplatesOK) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/link-templates][%d] listLinkTemplatesOK  %+v", 200, o.Payload)
}
...
func (o *ListLinkTemplatesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ConfigunstableListLinkTemplatesResponse)
...
func NewListLinkTemplatesInternalServerError() *ListLinkTemplatesInternalServerError {
	return &ListLinkTemplatesInternalServerError{}
}
...
func (o *ListLinkTemplatesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/link-templates][%d] listLinkTemplatesInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ListLinkTemplatesInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewListLinkTemplatesDefault(code int) *ListLinkTemplatesDefault {
	return &ListLinkTemplatesDefault{
		_statusCode: code,
	}
}
...
func (o *ListLinkTemplatesDefault) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/link-templates][%d] ListLinkTemplates default  %+v", o._statusCode, o.Payload)
}
...
func (o *ListLinkTemplatesDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
