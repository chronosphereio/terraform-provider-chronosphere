...
func (o *UpdateLogScaleAlertParams) WithBody(body UpdateLogScaleAlertBody) *UpdateLogScaleAlertParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update log scale alert params
func (o *UpdateLogScaleAlertParams) SetBody(body UpdateLogScaleAlertBody) {
	o.Body = body
}
