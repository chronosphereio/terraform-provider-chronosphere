...
func (o *ListLogScaleAlertsOK) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/log-scale-alerts][%d] listLogScaleAlertsOK  %+v", 200, o.Payload)
}
...
func (o *ListLogScaleAlertsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableListLogScaleAlertsResponse)
...
func (o *ListLogScaleAlertsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/log-scale-alerts][%d] listLogScaleAlertsInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ListLogScaleAlertsDefault) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/log-scale-alerts][%d] ListLogScaleAlerts default  %+v", o._statusCode, o.Payload)
}
