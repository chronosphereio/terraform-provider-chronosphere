...
func (o *UpdateLogScaleAlertOK) Error() string {
	return fmt.Sprintf("[PUT /api/unstable/config/log-scale-alerts/{slug}][%d] updateLogScaleAlertOK  %+v", 200, o.Payload)
}
...
func (o *UpdateLogScaleAlertOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableUpdateLogScaleAlertResponse)
...
func (o *UpdateLogScaleAlertBadRequest) Error() string {
	return fmt.Sprintf("[PUT /api/unstable/config/log-scale-alerts/{slug}][%d] updateLogScaleAlertBadRequest  %+v", 400, o.Payload)
}
...
func (o *UpdateLogScaleAlertNotFound) Error() string {
	return fmt.Sprintf("[PUT /api/unstable/config/log-scale-alerts/{slug}][%d] updateLogScaleAlertNotFound  %+v", 404, o.Payload)
}
...
func (o *UpdateLogScaleAlertConflict) Error() string {
	return fmt.Sprintf("[PUT /api/unstable/config/log-scale-alerts/{slug}][%d] updateLogScaleAlertConflict  %+v", 409, o.Payload)
}
...
func (o *UpdateLogScaleAlertInternalServerError) Error() string {
	return fmt.Sprintf("[PUT /api/unstable/config/log-scale-alerts/{slug}][%d] updateLogScaleAlertInternalServerError  %+v", 500, o.Payload)
}
...
func (o *UpdateLogScaleAlertDefault) Error() string {
	return fmt.Sprintf("[PUT /api/unstable/config/log-scale-alerts/{slug}][%d] UpdateLogScaleAlert default  %+v", o._statusCode, o.Payload)
}
...
/*
UpdateLogScaleAlertBody update log scale alert body
swagger:model UpdateLogScaleAlertBody
*/
type UpdateLogScaleAlertBody struct {
	...
	// log scale alert
	LogScaleAlert *models.ConfigunstableLogScaleAlert `json:"log_scale_alert,omitempty"`
}

// Validate validates this update log scale alert body
func (o *UpdateLogScaleAlertBody) Validate(formats strfmt.Registry) error {
	var res []error

	if err := o.validateLogScaleAlert(formats); err != nil {
		res = append(res, err)
	}
...
func (o *UpdateLogScaleAlertBody) validateLogScaleAlert(formats strfmt.Registry) error {
	if swag.IsZero(o.LogScaleAlert) { // not required
		return nil
	}

	if o.LogScaleAlert != nil {
		if err := o.LogScaleAlert.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("body" + "." + "log_scale_alert")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("body" + "." + "log_scale_alert")
			}
			return err
		}
	}
...
// ContextValidate validate this update log scale alert body based on the context it is used
func (o *UpdateLogScaleAlertBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := o.contextValidateLogScaleAlert(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *UpdateLogScaleAlertBody) contextValidateLogScaleAlert(ctx context.Context, formats strfmt.Registry) error {

	if o.LogScaleAlert != nil {
		if err := o.LogScaleAlert.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("body" + "." + "log_scale_alert")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("body" + "." + "log_scale_alert")
...
func (o *UpdateLogScaleAlertBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *UpdateLogScaleAlertBody) UnmarshalBinary(b []byte) error {
	var res UpdateLogScaleAlertBody
