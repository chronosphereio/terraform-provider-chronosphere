...
func (o *CreateLogScaleAlertOK) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/log-scale-alerts][%d] createLogScaleAlertOK  %+v", 200, o.Payload)
}
...
func (o *CreateLogScaleAlertOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableCreateLogScaleAlertResponse)
...
func (o *CreateLogScaleAlertBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/log-scale-alerts][%d] createLogScaleAlertBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateLogScaleAlertConflict) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/log-scale-alerts][%d] createLogScaleAlertConflict  %+v", 409, o.Payload)
}
...
func (o *CreateLogScaleAlertInternalServerError) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/log-scale-alerts][%d] createLogScaleAlertInternalServerError  %+v", 500, o.Payload)
}
...
func (o *CreateLogScaleAlertDefault) Error() string {
	return fmt.Sprintf("[POST /api/unstable/config/log-scale-alerts][%d] CreateLogScaleAlert default  %+v", o._statusCode, o.Payload)
}
