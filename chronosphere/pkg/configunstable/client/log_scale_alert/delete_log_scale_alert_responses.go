...
func (o *DeleteLogScaleAlertOK) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-scale-alerts/{slug}][%d] deleteLogScaleAlertOK  %+v", 200, o.Payload)
}
...
func (o *DeleteLogScaleAlertBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-scale-alerts/{slug}][%d] deleteLogScaleAlertBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteLogScaleAlertNotFound) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-scale-alerts/{slug}][%d] deleteLogScaleAlertNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteLogScaleAlertInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-scale-alerts/{slug}][%d] deleteLogScaleAlertInternalServerError  %+v", 500, o.Payload)
}
...
func (o *DeleteLogScaleAlertDefault) Error() string {
	return fmt.Sprintf("[DELETE /api/unstable/config/log-scale-alerts/{slug}][%d] DeleteLogScaleAlert default  %+v", o._statusCode, o.Payload)
}
