...
func (o *ListServicesOK) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/services][%d] listServicesOK  %+v", 200, o.Payload)
}
...
func (o *ListServicesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableListServicesResponse)
...
func (o *ListServicesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/services][%d] listServicesInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ListServicesDefault) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/services][%d] ListServices default  %+v", o._statusCode, o.Payload)
}
