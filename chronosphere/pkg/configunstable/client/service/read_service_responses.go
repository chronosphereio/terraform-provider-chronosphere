...
func (o *ReadServiceOK) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/services/{slug}][%d] readServiceOK  %+v", 200, o.Payload)
}
...
func (o *ReadServiceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfigunstableReadServiceResponse)
...
func (o *ReadServiceNotFound) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/services/{slug}][%d] readServiceNotFound  %+v", 404, o.Payload)
}
...
func (o *ReadServiceInternalServerError) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/services/{slug}][%d] readServiceInternalServerError  %+v", 500, o.Payload)
}
...
func (o *ReadServiceDefault) Error() string {
	return fmt.Sprintf("[GET /api/unstable/config/services/{slug}][%d] ReadService default  %+v", o._statusCode, o.Payload)
}
