...
func resourceWebhookExternalConnection() *schema.Resource {
	...
	return &schema.Resource{
		...
		Description:   "Workspace-scoped webhook credentials that downstream notifiers can reference. Centralizes the destination URL and HTTP auth so they aren't duplicated across notifiers; modern equivalent of the per-notifier credentials.",
