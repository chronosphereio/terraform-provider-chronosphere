...
func allocationToModel(a *intschema.LogAllocationSchema) *models.LogAllocationConfigAllocation {
...
func allocationFromModel(a *models.LogAllocationConfigAllocation) *intschema.LogAllocationSchema {
	return &intschema.LogAllocationSchema{
		PercentOfLicense: a.PercentOfLicense,
	}
}
