...
type generatedCommandCenterGroup struct{}

func (generatedCommandCenterGroup) slugOf(m *configv1models.Configv1CommandCenterGroup) string {
	return m.Slug
}

func (generatedCommandCenterGroup) create(
	ctx context.Context,
	clients apiclients.Clients,
	m *configv1models.Configv1CommandCenterGroup,
	dryRun bool,
) (string, error) {
	req := &command_center_group.CreateCommandCenterGroupParams{
		Context: ctx,
		Body: &configv1models.Configv1CreateCommandCenterGroupRequest{
			CommandCenterGroup: m,
			DryRun:             dryRun,
		},
	}
	resp, err := clients.ConfigV1.CommandCenterGroup.CreateCommandCenterGroup(req)
	if err != nil {
		return "", err
	}
	...
	return (generatedCommandCenterGroup{}).slugOf(e), nil
}

func (generatedCommandCenterGroup) read(
	ctx context.Context,
	clients apiclients.Clients,
	slug string,
	...
	resp, err := clients.ConfigV1.CommandCenterGroup.ReadCommandCenterGroup(req)
	if err != nil {
		return nil, err
	}
...
func (generatedCommandCenterGroup) update(
	ctx context.Context,
	clients apiclients.Clients,
	m *configv1models.Configv1CommandCenterGroup,
	params updateParams,
	...
	req := &command_center_group.UpdateCommandCenterGroupParams{
		...
		Body: &configv1models.ConfigV1UpdateCommandCenterGroupBody{
	...
	_, err := clients.ConfigV1.CommandCenterGroup.UpdateCommandCenterGroup(req)
	return err
}
func (generatedCommandCenterGroup) delete(
	ctx context.Context,
	clients apiclients.Clients,
	slug string,
) error {
	...
	_, err := clients.ConfigV1.CommandCenterGroup.DeleteCommandCenterGroup(req)
	return err
}
