...
func resourceOpsgenieExternalConnection() *schema.Resource {
	...
	return &schema.Resource{
		...
		Description:   "Workspace-scoped OpsGenie credentials that downstream notifiers can reference. Centralizes the OpsGenie API key so it isn't duplicated across individual notifiers; modern equivalent of the per-notifier credentials.",
